        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    listHotel.add(new Hotel(e.getString("nama"),
                            new Lokasi(lokasi.getInt("x_coord"),lokasi.getInt("y_coord"),lokasi.getString("deskripsi")),
                            e.getInt("bintang")));

                    for(int i = 0;i<3;i++) {
                        JSONObject room = jsonResponse.getJSONObject(i);
                        listRoom.add(new Room(room.getString("roomNumber"),
